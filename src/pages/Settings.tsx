    ...
    <div className="container mx-auto">
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-center">Управление настройками приложения и статистика</CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <Card>
                    <CardContent className="p-6">
                      <div className="text-center">
                        <div className="text-4xl font-bold text-accent mb-1">{stats.searches}</div>
                        <div className="text-sm text-muted-foreground">Поисковых запросов</div>
                      </div>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-6">
                      <div className="text-center">
                        <div className="text-4xl font-bold text-accent mb-1">{stats.loggers}</div>
                        <div className="text-sm text-muted-foreground">IP логгеров</div>
                      </div>
                    </CardContent>
                  </Card>
                </div>
                ...
                <Card>
                  <CardContent className="p-6 space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between text-sm">
                        <span>Успешных:</span>
                        <span className="font-medium text-green-400">{Math.floor(stats.totalQueries * 0.85)}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Неудачных:</span>
                        <span className="font-medium text-red-400">{Math.floor(stats.totalQueries * 0.15)}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
